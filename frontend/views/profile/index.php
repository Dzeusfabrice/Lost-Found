...
<div style="max-width: 1100px; margin: 0 auto;">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 4rem;">
        <div>
            ...
            <h1 style="font-size: 3rem; font-weight: 800; letter-spacing: -2px; line-height: 1.1; margin-bottom: 0.5rem; color: var(--text-main);">Bonjour, <span class="text-gradient"><?= e($user['name']) ?>.</span></h1>
        ...
        <div style="display: flex; gap: 1rem;">
             <a href="<?= BASE_URL ?>/index.php?action=ads.create" class="btn btn-primary" style="padding: 1rem 2rem; border-radius: 99px;"><i class="fas fa-plus-circle"></i> Publier un signalement</a>
    ...
    <div style="display: grid; grid-template-columns: 350px 1fr; gap: 4rem; align-items: flex-start;">
        <!-- Card Profil GAUCHE -->
            ...
            <?php else: ?>
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    <?php foreach ($ads as $ad): ?>
                        <div class="card" style="padding: 1.25rem; border: none; background: white; border-radius: 2rem; box-shadow: var(--shadow-lg); display: flex; align-items: center; gap: 2rem; transition: var(--transition);">
