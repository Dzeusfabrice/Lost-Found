...
<div style="max-width: 1100px; margin: 0 auto;">
    <div style="text-align: center; margin-bottom: 4rem;">
        ...
        <h1 style="font-size: 3.5rem; font-weight: 800; letter-spacing: -2px; margin-bottom: 1rem; color: var(--text-main);">Qu'avez-vous <span class="text-gradient">perdu ?</span></h1>
    ...
    <div class="card" style="padding: 2.5rem; margin-bottom: 5rem; border: none; border-radius: 3rem; background: white; box-shadow: var(--shadow-xl);">
        <form action="<?= BASE_URL ?>/index.php" method="GET" style="display: grid; grid-template-columns: 2fr 1fr 1fr 100px; gap: 1rem; align-items: flex-end;">
